...
ClapTrap::ClapTrap() {
    std::cout << GREEN1 << "Default constructor called" << GREEN2 << std::endl;
    this->_name = "default";
    this->_hitPoints = 10;
...
ClapTrap::ClapTrap(std::string _name) {
    std::cout << GREEN1 << "Name constructor called" << GREEN2 << std::endl;
    this->_name = _name;
    this->_hitPoints = 10;
    this->_energyPoints = 10;
    this->_attakDamage = 0;
...
ClapTrap::ClapTrap( const ClapTrap &p ) {
    std::cout << GREEN1 << "Copy constructor called" << GREEN2 << std::endl;
    *this = p;
}

ClapTrap& ClapTrap::operator=( const ClapTrap &p ) {
    std::cout << GREEN1 << "Copy assignment operator called" << GREEN2 << std::endl;
    if (this != &p) {
        _name = p._name;
...
ClapTrap::~ClapTrap() {
    std::cout << GREEN1 << "Destructor called" << GREEN2 << std::endl;
}
